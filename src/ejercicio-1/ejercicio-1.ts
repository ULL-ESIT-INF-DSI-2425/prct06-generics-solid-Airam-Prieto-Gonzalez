// import { Series, Documentals, Films } from './Collection_Classes'
// import { Serie, Film, Documental } from './Stream_Classes'
...
// console.log(SerieCollection.GetStream('Squid Game'))
// console.log(SerieCollection.SearchByYear(2023))
// console.log(SerieCollection.SearchBySeasons(2))