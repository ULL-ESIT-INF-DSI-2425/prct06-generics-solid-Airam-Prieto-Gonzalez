...
import { Stream, Serie, Film, Documental, Gender, Topic } from "./Stream_Classes"
 ...
 */ 
abstract class BasicStreamableCollection<T extends Stream> implements SearchStreamable<T> {
 ...
 * @param {T[]} StreamArray Array of Streams
 */
export class Documentals<T extends Documental> extends BasicStreamableCollection<T> {
        constructor(topic: string) {
                super(topic)
        }
