...
export class Serie extends Stream {
        ...
        constructor(name: string, year: number, duration: number, creator: string, seasons: number) {
...
export class Film extends Stream {
         ...
         */
        constructor(name: string, year: number, duration: number, creator: string, gender: Gender) {
                super(name, year, duration, creator)
                this.gender = gender
        }
}
...
export class Documental extends Stream {
         ...
         */
        constructor(name: string, year: number, duration: number, creator: string, topic: Topic) {
                super(name, year, duration, creator)
                this.topic = topic
        }
}